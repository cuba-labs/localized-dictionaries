...
public class DictionariesTestContainer extends TestContainer {

    public DictionariesTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/dictionaries/app.properties",
    ...
    public static class Common extends DictionariesTestContainer {

        public static final DictionariesTestContainer.Common INSTANCE = new DictionariesTestContainer.Common();
